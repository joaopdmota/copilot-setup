...
- Read `.github/memory.md` to understand project decisions
- Read all `.github/rules/` to know quality standards
- Scan project structure to understand scope

### 2. Code Quality Audit

- Check adherence to coding standards in `.github/rules/`
...
- If critical issues are found, update `.github/memory.md` with lessons learned
