...
Validate if the implemented code follows the rules defined in `.github/rules/` and if requirements were met in a clean and secure way.
...
- If **critical issues** are found (security vulnerabilities, major architectural violations), update `.github/memory.md`:
